...
GEN_ABSOLUTE_SYM(CONFIG_UART_0_NRF_TX_PIN, 6);
GEN_ABSOLUTE_SYM(CONFIG_UART_0_NRF_RX_PIN, 8);
GEN_ABSOLUTE_SYM(CONFIG_UART_0_NRF_CTS_PIN, 7);
GEN_ABSOLUTE_SYM(CONFIG_UART_0_NRF_RTS_PIN, 5);
...
GEN_ABSOLUTE_SYM(CONFIG_GPIO_NRF5_INIT_PRIORITY, 40);
GEN_ABSOLUTE_SYM(CONFIG_GPIO_NRF5_P0, 1);
GEN_ABSOLUTE_SYM(CONFIG_GPIO_NRF5_P0_DEV_NAME, 1);
GEN_ABSOLUTE_SYM(CONFIG_GPIOTE_NRF5_PRI, 5);
...
GEN_ABSOLUTE_SYM(CONFIG_BT_DEBUG_RPA, 1);
...
GEN_ABSOLUTE_SYM(CONFIG_BT_ACL_RX_COUNT, 2);
...
GEN_ABSOLUTE_SYM(CONFIG_BT_SCAN_WITH_IDENTITY, 1);
...
GEN_ABSOLUTE_SYM(CONFIG_BT_DEBUG_CONN, 1);
...
GEN_ABSOLUTE_SYM(CONFIG_SYS_LOG_DISK_LEVEL, 0);
